...
if (!empty($_POST)) {
    ...
    //Define an array to contain errors when execute query, if there are errors, we will ouput to screen
    $errors = [];
    try {
...
<div id="main">
    <div id="main-content">
        ...
        <?php
        // if user registered, show welcome message
        } else {
            echo "<p>Welcome to our webside!</p>";
        }
        ?>
    </div>
    <!-- embed sidbar.php -->
